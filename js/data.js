...
export async function register() { return login(); }

export function logout() {}

// ===== 照片（本地 base64 存储） =====

export async function uploadPhoto(_placeId, file) {
  ...
  return { id: crypto.randomUUID(), dataUrl, caption: '' };
}

export function deletePhoto(_photoId) {}
